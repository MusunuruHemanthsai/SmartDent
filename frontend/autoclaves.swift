...
struct AutoclaveDetailView: View {
    let userId: Int
    let productId = 14  // ← you can update this ID based on your usage
    ...
    private func loadProduct() {
        guard let url = URL(string: "\(ServiceAPI.productDetails)?product_id=\(14)") else {
