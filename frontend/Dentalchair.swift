...
struct DentalChairDetailView1: View {
    ...
    private func loadProduct() {
        guard let url = URL(string: "\(ServiceAPI.productDetails)?product_id=\(18)") else {
...
struct DentalChairDetailView_Previews1: PreviewProvider {
