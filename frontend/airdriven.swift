...
struct AirDrivenHandpiecesDetailView: View {
    let userId: Int
                    ...
                    ScrollView {
                        VStack(spacing: 20) {
                            ...
                            HStack(spacing: 20) {
                                ...
                                Text("\(quantity)").font(.title2).fontWeight(.bold)
    ...
    private func loadProduct() {
        guard let url = URL(string: "\(ServiceAPI.productDetails)?product_id=\(6)") else {
