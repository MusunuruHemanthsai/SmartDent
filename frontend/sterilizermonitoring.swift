...
struct SterilizerDetailView: View {
    let userId: Int
    private let productId = 16
    ...
    private func loadProduct() {
        guard let url = URL(string: ServiceAPI.productDetailURL(for: 16)) else {
...
struct SterilizerDetailView_Previews: PreviewProvider {
    static var previews: some View {
        SterilizerDetailView(userId: 1)
    }
}
