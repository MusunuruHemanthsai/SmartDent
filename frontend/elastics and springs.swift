...
struct ElasticsAndSpringsDetailView: View {
    let userId: Int
    ...
    private func fetchProduct() {
        guard let url = URL(string: "\(ServiceAPI.productDetails)?product_id=\(27)") else {
...
struct ElasticsAndSpringsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        ElasticsAndSpringsDetailView(userId: 1)
    }
}
