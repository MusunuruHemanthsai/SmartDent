...
struct MixAndDispenserDetailView: View {
    let userId: Int
    ...
    private let productId = 12
    private var apiURL: String {
        return "\(ServiceAPI.productDetails)?product_id=\(12)"
    }
...
// MARK: - Preview
struct MixAndDispenserDetailView_Previews: PreviewProvider {
    static var previews: some View {
        MixAndDispenserDetailView(userId: 1)
    }
}
