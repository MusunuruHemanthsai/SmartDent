...
struct ElevatorsDetailView: View {
    ...
    private func loadProduct() {
        guard let url = URL(string: "\(ServiceAPI.productDetails)?product_id=\(23)") else {
...
struct ElevatorsDetailView_Previews: PreviewProvider {
