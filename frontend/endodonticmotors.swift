...
struct EndodonticMotorsDetailView: View {
    let userId: Int
    ...
    private func fetchProduct() {
        guard let url = URL(string: "\(ServiceAPI.productDetails)?product_id=\(31)") else {
...
struct EndodonticMotorsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        EndodonticMotorsDetailView(userId: 1)
    }
}
