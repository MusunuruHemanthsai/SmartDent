...
struct UVSterilizerDetailView: View {
    let userId: Int
    private let productId = 17
    ...
    private func loadProduct() {
        guard let url = URL(string: ServiceAPI.productDetailURL(for: 17)) else {
...
struct UVSterilizerDetailView_Previews: PreviewProvider {
    static var previews: some View {
        UVSterilizerDetailView(userId: 1)
    }
}
