...
struct OperatingLightView: View {
    let userId: Int
    ...
    private let productId = 19
    private var apiURL: String {
        return "\(ServiceAPI.productDetails)?product_id=\(19)"
    }
...
// MARK: - Preview
struct OperatingLightView_Previews: PreviewProvider {
    static var previews: some View {
        OperatingLightView(userId: 1)
    }
}
