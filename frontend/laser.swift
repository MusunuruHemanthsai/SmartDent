...
struct LaserEquipmentDetailView: View {
    let userId: Int
    ...
    private let productId = 8
    private var apiURL: String {
        return "\(ServiceAPI.productDetails)?product_id=\(8)"
    }
...
// MARK: - Preview
struct LaserEquipmentDetailView_Previews: PreviewProvider {
    static var previews: some View {
        LaserEquipmentDetailView(userId: 1)
    }
}
