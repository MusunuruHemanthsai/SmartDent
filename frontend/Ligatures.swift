...
struct LigaturesDetailView: View {
    let userId: Int
    ...
    private let productId = 28
    private var apiURL: String {
        return "\(ServiceAPI.productDetails)?product_id=\(28)"
    }
...
// MARK: - Preview
struct LigaturesDetailView_Previews: PreviewProvider {
    static var previews: some View {
        LigaturesDetailView(userId: 1)
    }
}
