...
struct UltrasonicCleanerDetailView: View {
    let userId: Int
    ...
    private func loadProduct() {
        guard let url = URL(string: ServiceAPI.productDetailURL(for: 15)) else {
...
struct UltrasonicCleanerDetailView_Previews: PreviewProvider {
    static var previews: some View {
        UltrasonicCleanerDetailView(userId: 1)
    }
}
