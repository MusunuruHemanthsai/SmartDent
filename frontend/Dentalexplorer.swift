...
struct DentalExplorerDetailView: View {
    let userId: Int // Must be passed when this view is initialized
    ...
    // MARK: - API URLs from ServiceAPI
    private var apiURL: String {
        "\(ServiceAPI.productDetails)?product_id=\(2)"
    }
                ...
                if isLoading {
                    ...
                    .toolbar {
                        ToolbarItem(placement: .principal) {
                            Image("a") // Replace with your logo if needed
                                .resizable()
                                .scaledToFit()
                                .frame(height: 100)
                                .offset(y: -50)
