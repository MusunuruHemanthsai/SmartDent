...
struct ArchwireDetailView: View {
    let userId: Int
    private let productId = 26
    ...
    private func fetchProduct() {
        guard let url = URL(string: "\(ServiceAPI.productDetails)?product_id=\(26)") else {
...
struct ArchwireDetailView_Previews: PreviewProvider {
    static var previews: some View {
        ArchwireDetailView(userId: 1)
    }
}
