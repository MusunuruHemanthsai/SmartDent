...
struct VacuumFormerDetailView: View {
    let userId: Int
    private let productId = 11
    ...
    private func loadProduct() {
        guard let url = URL(string: ServiceAPI.productDetailURL(for: 11)) else {
...
struct VacuumFormerDetailView_Previews: PreviewProvider {
    static var previews: some View {
        VacuumFormerDetailView(userId: 1)
    }
}
