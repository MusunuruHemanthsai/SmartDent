...
struct SuctionDeviceDetailView: View {
    let userId: Int
    private let productId = 20
    ...
    private func loadProduct() {
        guard let url = URL(string: ServiceAPI.productDetailURL(for: 20)) else {
...
struct SuctionDeviceDetailView_Previews: PreviewProvider {
    static var previews: some View {
        SuctionDeviceDetailView(userId: 1)
    }
}
